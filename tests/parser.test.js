...
const validCases = [
  ...
  ['10 hm', { type: 'length', value: 10, unit: 'hm' }],
  ['10 dam', { type: 'length', value: 10, unit: 'dam' }],
  ['10 dkm', { type: 'length', value: 10, unit: 'dam' }],
  ['10 dm', { type: 'length', value: 10, unit: 'dm' }],
  ['5 kg', { type: 'weight', value: 5, unit: 'kg' }],
  ['5 hg', { type: 'weight', value: 5, unit: 'hg' }],
  ['5 dag', { type: 'weight', value: 5, unit: 'dag' }],
  ['5 dg', { type: 'weight', value: 5, unit: 'dg' }],
  ['5 cg', { type: 'weight', value: 5, unit: 'cg' }],
